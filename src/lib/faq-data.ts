...
export const INITIAL_FAQ_DATA = [
  ...
  { categorie: "Boat Tracker", ordre: 42, question: "Pourquoi mon navire est mis à jour toutes les minutes ?", reponse: "Pour garantir une sécurité maximale et une détection rapide des anomalies. Ce rafraîchissement forcé permet aussi de calculer précisément votre temps d'activité." },
  { categorie: "Boat Tracker", ordre: 43, question: "C'est quoi le Mode Fantôme ?", reponse: "Il permet de masquer votre position GPS sur les cartes distantes. Vous restez invisible tout en recevant les alertes des autres membres de la flotte. Idéal pour la discrétion." },
  { categorie: "Boat Tracker", ordre: 44, question: "Le Mode Fantôme protège-t-il en cas d'urgence ?", reponse: "Oui ! En cas de 'Demande d'Assistance', le mode Fantôme est annulé. Votre navire devient visible sur toutes les cartes pour permettre aux secours de vous trouver." },
  { categorie: "Boat Tracker", ordre: 45, question: "Comment marche la 'Veille Stratégique' ?", reponse: "Le récepteur définit un temps (ex: 1h). Si le navire émetteur reste immobile (statut Mouillage) plus longtemps que ce délai, une alarme retentit chez le récepteur." },
  { categorie: "Boat Tracker", ordre: 46, question: "Pourquoi les journaux de bord sont-ils séparés ?", reponse: "Le journal 'Statuts' gère les mouvements techniques. Le journal 'Tactique' regroupe vos oiseaux et prises. Vous pouvez ainsi effacer vos traces sans perdre vos points de pêche." },
  { categorie: "Boat Tracker", ordre: 47, question: "L'effacement du journal est-il définitif ?", reponse: "Si l'Émetteur A clique sur Reset, les points sont supprimés pour TOUS les utilisateurs. Si un Récepteur B clique sur Reset, cela ne vide que son propre écran." },
  { categorie: "Boat Tracker", ordre: 48, question: "Quelle est la différence entre Récepteur B et Flotte C ?", reponse: "Le mode B est privé (ID navire secret). Le mode C est communautaire (ID de groupe partagé, ex: une association de pêche)." },
  { categorie: "Boat Tracker", ordre: 49, question: "Comment signaler une prise de poisson ?", reponse: "Cliquez sur 'Signaler Prise' et choisissez l'espèce (Marlin, Thon, etc.). Une icône colorée s'affiche sur la carte pour tout votre groupe." },
  { categorie: "Boat Tracker", ordre: 50, question: "Mon navire apparaît-il sur ma propre carte ?", reponse: "Oui, l'émetteur voit toujours son navire, même en mode Fantôme, pour confirmer son propre statut et sa position." },
  { categorie: "Boat Tracker", ordre: 51, question: "Peut-on voir depuis combien de temps on fait route ?", reponse: "Oui, le journal de bord indique pour chaque statut 'Actif depuis X min', calculé à partir du changement d'état." },
  { categorie: "Boat Tracker", ordre: 52, question: "Le GPS minute consomme-t-il plus ?", reponse: "Oui, prévoyez une batterie externe. Le mode 'Éveil' est conseillé pour que le smartphone ne coupe pas les transmissions en veille." },
  { categorie: "Boat Tracker", ordre: 53, question: "Comment régler le rayon de détection de dérive ?", reponse: "Utilisez le réglage 'Rayon de mouillage'. Par mer forte, augmentez-le à 50m ou 100m pour éviter les fausses alertes dues à l'évitage du bateau." },
  { categorie: "Boat Tracker", ordre: 54, question: "Peut-on copier un point GPS de prise ?", reponse: "Oui, dans le Journal Tactique, cliquez sur l'icône Copier pour récupérer les coordonnées exactes d'un Marlin ou d'une chasse d'oiseaux." },
  { categorie: "Boat Tracker", ordre: 55, question: "Les alertes sonores sont-elles automatiques ?", reponse: "Oui, si l'interrupteur 'Alertes Sonores' est activé. Vous pouvez choisir un son différent pour chaque événement (Mouillage, Dérive, SOS)." },
