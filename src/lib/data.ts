  ...
  fishing: [
    {
      ...
      fish: [
        ...
        { name: 'Dawa (Saumonée)', rating: 8, location: 'Lagon', advice: { activity: 'Active, chasse à l\'affût près des structures.', feeding: 'Bonne heure, se nourrit de petits poissons et crustacés.', location_specific: 'Patates de corail, petits tombants et zones d\'éboulis.', depth: '5-20m.' } },
    ...
    },
    {
      ...
      fish: [
        ...
        { name: 'Dawa (Saumonée)', rating: 6, location: 'Lagon', advice: { activity: 'Activité modérée, reste à l\'affût près des cailloux.', feeding: 'Heure correcte, peut être opportuniste.', location_specific: 'Alentours des patates de corail et zones ombragées.', depth: '5-20m.' } },
    ...
    },
    {
      ...
      fish: [
        ...
        { name: 'Dawa (Saumonée)', rating: 9, location: 'Lagon', advice: { activity: 'Très active, pic d\'activité au crépuscule.', feeding: 'Excellente heure, devient un prédateur redoutable.', location_specific: 'Patates de corail, tombants, et zones rocheuses.', depth: '5-20m.' } },
