...
export function BottomNav() {
  ...
  // Détection robuste des rôles pour le filtrage (Identique à SidebarNav)
  const roles = useMemo(() => {
    ...
    const masterAdminEmails = ['f.mallet81@outlook.com', 'fabrice.mallet@gmail.com', 'f.mallet81@gmail.com', 'kledostyle@outlook.com'];
  ...
  const visibleLinks = mobileTabs.map(href => {
    ...
    // Filtrage basé sur les rôles Master
