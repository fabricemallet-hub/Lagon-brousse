    ...
    <div className="space-y-6 w-full max-w-full overflow-x-hidden">
      <Tabs defaultValue="weather" className="w-full">
        <TabsList className="grid w-full grid-cols-2 h-12 bg-muted/50 rounded-none p-1 border-b">
          <TabsTrigger value="weather" className="text-sm font-black uppercase tracking-tighter">Météo & Marées</TabsTrigger>
          <TabsTrigger value="tracker" className="text-sm font-black uppercase tracking-tighter">Vessel Tracker</TabsTrigger>
        </TabsList>

        <TabsContent value="weather" className="space-y-6 pt-4 px-1">
          <Card className="w-full shadow-none border">
            <CardHeader className="p-4 pb-2">
              <CardTitle className="text-xl font-black">État de la mer</CardTitle>
              <CardDescription className="text-xs">Prévisions pour {selectedLocation}</CardDescription>
            </CardHeader>
