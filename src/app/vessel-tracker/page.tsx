    ...
    watchIdRef.current = navigator.geolocation.watchPosition(
      (position) => {
        ...
        if (vesselStatus !== 'returning' && vesselStatus !== 'landed') {
            ...
            // Ignorer les mouvements si inférieurs à la marge d'erreur GPS
            const isActuallyMoving = dist > IMMOBILITY_THRESHOLD_METERS && dist > (accuracy * 0.8);
                                        ...
                                        <div key={i} className="flex items-center justify-between p-3 bg-white rounded-xl border-2 text-[10px] shadow-sm animate-in fade-in slide-in-from-left-2">
                                            <div className="flex flex-col gap-0.5">
                                              ...
                                              <div className="flex items-center gap-2 opacity-40 font-bold">
                                                <span>{format(h.time, 'dd/MM HH:mm:ss')}</span>
