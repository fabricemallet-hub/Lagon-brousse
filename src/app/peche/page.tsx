...
import { Clock, Waves, TrendingUp, TrendingDown, Fish, Star, Info, Map as MapIcon, Users } from 'lucide-react';
    ...
    <div className="w-full max-w-full overflow-x-hidden space-y-6 pb-8 px-1">
      <Card className="w-full border-none shadow-none bg-transparent">
        <CardHeader className="px-0 py-2">
          <CardTitle className="text-2xl font-black uppercase tracking-tighter">Pêche Tactique</CardTitle>
          <CardDescription className="text-xs">Indices de réussite et carnet de spots à {selectedLocation}</CardDescription>
        </CardHeader>
      </Card>
      ...
      <Tabs defaultValue="forecast" className="w-full">
        <TabsList className="grid w-full grid-cols-2 gap-2 h-auto mb-8 bg-transparent p-0 border-none">
          ...
          >
            <div className="p-2 rounded-xl bg-primary/10 text-primary group-data-[state=active]:bg-white/20 group-data-[state=active]:text-white transition-colors">
              <Fish className="size-5" />
            </div>
            <span className="font-black uppercase text-[9px] tracking-widest leading-none">Activité</span>
          </TabsTrigger>
          
          <TabsTrigger 
            value="log" 
            className="group flex flex-col items-center justify-center gap-2 py-4 rounded-[2rem] border-2 transition-all data-[state=active]:bg-indigo-600 data-[state=active]:text-white data-[state=active]:border-indigo-600 data-[state=active]:shadow-xl data-[state=inactive]:bg-white data-[state=inactive]:border-indigo-50 active:scale-95"
          >
            <div className="p-2 rounded-xl bg-indigo-50 text-indigo-600 group-data-[state=active]:bg-white/20 group-data-[state=active]:text-white transition-colors">
